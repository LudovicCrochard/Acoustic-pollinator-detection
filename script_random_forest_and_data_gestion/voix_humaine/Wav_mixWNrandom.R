...
DirW="E:/travail_manip_tournesol/doc_voix_humaine/voix_humaine_database" #input folder
DestMix="E:/travail_manip_tournesol/doc_voix_humaine/voix_humaine_database_noisedCoef40" #output folder
